...
class VectorDBMetadata():
    def __init__(self, name: str, remote_path: str, local_path: str, model_name: str, model_type: str, describe: str) -> None:
        self.name = name
...
def get_meta_from_json(obj: dict) -> VectorDBMetadata:
    return VectorDBMetadata(obj["name"], obj["remote_path"], obj["local_path"],
                            obj["model_name"], obj["model_type"], obj["describe"])
